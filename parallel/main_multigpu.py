...
if __name__ == "__main__":
    ...
    parser.add_argument('--h5_file', type=str, default="/p/scratch/training2321/data/imagenet100k.h5")
    parser.add_argument('--imagenet_root', type=str, default="/p/scratch/training2321/data/")
